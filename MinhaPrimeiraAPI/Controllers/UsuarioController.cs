...
namespace MinhaPrimeiraAPI.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public IEnumerable<UsuarioModel> Get()
        {
            ...
            usuarioModels.Add(new UsuarioModel() { Id = 1, Nome = "Acaciano Neves", Email = "acaciano.neves@gmail.com" });
        ...
        {
            UsuarioModel usuario = new UsuarioModel() { Id = 1, Nome = "Acaciano Neves", Email = "acaciano.neves@gmail.com" };
